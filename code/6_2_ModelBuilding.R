...
myBiomodData <- readRDS("data/rds/6_biomod2_data.rds") # biomod2 data
str(myBiomodData) # 395

DataSplitTable <- readRDS("data/rds/6_CV_folds_biomod.rds")
...
saveRDS(eval, file = "Output/6_AllMods_evalStats.rds")
...
# Save importance values
saveRDS(imp_df, file = "Output/6_VarImp_ALL.rds")
...
# Save evaluations
saveRDS(eval_em, file = "Output/6_Ensemble_evalStats.rds")
