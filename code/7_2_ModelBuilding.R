...
myBiomodData <- readRDS("data/rds/7_biomod2_data.rds") # biomod2 data
str(myBiomodData) # 969

DataSplitTable <- readRDS("data/rds/7_CV_folds_biomod.rds")
dim(DataSplitTable) # 969
...
saveRDS(eval, file = "Output/7_AllMods_evalStats.rds")
...
# Save importance values
saveRDS(imp_df, file = "Output/7_VarImp_ALL.rds")
...
# Save evaluations
saveRDS(eval_em, file = "Output/7_Ensemble_evalStats.rds")
...
# Save importance values
saveRDS(table_var_impEM, file = "Output/5_VarImp_Ensemble.rds")
