...
myBiomodData <- readRDS("data/rds/8_biomod2_data.rds") # biomod2 data
str(myBiomodData) # 1030

DataSplitTable <- readRDS("data/rds/8_CV_folds_biomod.rds")
...
saveRDS(eval, file = "Output/8_AllMods_evalStats.rds")
...
saveRDS(imp_df, file = "Output/8_VarImp_ALL.rds")
...
# Save evaluations
saveRDS(eval_em, file = "Output/8_Ensemble_evalStats.rds")
...
# Save importance values
saveRDS(table_var_impEM, file = "Output/8_VarImp_Ensemble.rds")
