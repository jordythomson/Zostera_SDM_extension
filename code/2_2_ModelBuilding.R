...
myBiomodData <- readRDS("data/rds/2_biomod2_data.rds") # biomod2 data
str(myBiomodData) # 1129

DataSplitTable <- readRDS("data/rds/2_CV_folds_biomod.rds")
...
# Save importance values
saveRDS(imp_df, file = "Output/2_VarImp_ALL.rds")
...
# Save evaluations
saveRDS(eval_em, file = "Output/2_Ensemble_evalStats.rds")
...
# Save importance values
saveRDS(table_var_impEM, file = "Output/2_VarImp_Ensemble.rds")
