...
str(myBiomodData) # 1123

# Save biomod2 formatted data
saveRDS(myBiomodData, file = "data/rds/1_biomod2_data.rds")
...
head(DataSplitTable)
dim(DataSplitTable) # 1123

# Save CV partition
saveRDS(DataSplitTable, file = "data/rds/1_CV_folds_biomod.rds")
