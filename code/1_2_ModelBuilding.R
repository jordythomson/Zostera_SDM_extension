...
myBiomodData <- readRDS("data/rds/1_biomod2_data.rds") # biomod2 data
str(myBiomodData) # 1129

DataSplitTable <- readRDS("data/rds/1_CV_folds_biomod.rds")
...
# Save evaluations
saveRDS(eval_em, file = "Output/Ensemble_evalStats.rds")

# Read in John's original ensemble evaluation stats summary for comparison
eval_em_JohnOrig <- readRDS("Output/Ensemble_evalStats_JohnOrig.rds")
eval_em_JohnOrig
...
# Save importance values
saveRDS(table_var_impEM, file = "Output/VarImp_Ensemble.rds")
