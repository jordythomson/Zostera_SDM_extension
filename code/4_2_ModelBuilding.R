...
myBiomodData <- readRDS("data/rds/4_biomod2_data.rds") # biomod2 data
str(myBiomodData) # 476

DataSplitTable <- readRDS("data/rds/4_CV_folds_biomod.rds")
dim(DataSplitTable) # 476
...
saveRDS(eval, file = "Output/4_AllMods_evalStats.rds")
...
# Save importance values
saveRDS(imp_df, file = "Output/4_VarImp_ALL.rds")
...
# Save evaluations
saveRDS(eval_em, file = "Output/4_Ensemble_evalStats.rds")
...
# Save importance values
saveRDS(table_var_impEM, file = "Output/4_VarImp_Ensemble.rds")
...
myEnsembleProjection <- BIOMOD_EnsembleForecasting(bm.em = myBiomodEM,
                                                   ...
                                                   proj.name = "EM_CurrentZostera_projection",
                                                   models.chosen = "ZosteraMarina_EMwmeanByROC_allData_RUN2_mergedAlgo",
