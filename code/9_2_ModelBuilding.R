...
myBiomodData <- readRDS("data/rds/10_biomod2_data.rds") # biomod2 data
str(myBiomodData) # 1044

DataSplitTable <- readRDS("data/rds/10_CV_folds_biomod.rds")
...
saveRDS(eval, file = "Output/10_AllMods_evalStats.rds")
...
saveRDS(imp_df, file = "Output/10_VarImp_ALL.rds")
...
# Save evaluations
saveRDS(eval_em, file = "Output/10_Ensemble_evalStats.rds")
...
# Save importance values
saveRDS(table_var_impEM, file = "Output/10_VarImp_Ensemble.rds")
