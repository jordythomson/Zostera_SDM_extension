...
str(myBiomodData) # 395

# Save biomod2 formatted data
saveRDS(myBiomodData, file = "data/rds/6_biomod2_data.rds")
...
head(DataSplitTable)
dim(DataSplitTable) # 395

# Save CV partition
saveRDS(DataSplitTable, file = "data/rds/6_CV_folds_biomod.rds")
