...
str(myBiomodData) # 861

# Save biomod2 formatted data
saveRDS(myBiomodData, file = "data/rds/5_biomod2_data.rds")
...
head(DataSplitTable)
dim(DataSplitTable) # 861

# Save CV partition
saveRDS(DataSplitTable, file = "data/rds/5_CV_folds_biomod.rds")
